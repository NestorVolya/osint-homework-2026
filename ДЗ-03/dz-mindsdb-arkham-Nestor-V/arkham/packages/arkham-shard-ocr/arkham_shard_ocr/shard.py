...
class OCRShard(ArkhamShard):
    ...
    def __init__(self):
        ...
        self._default_language = os.environ.get("OCR_DEFAULT_LANGUAGE", "en")
    ...
    async def initialize(self, frame) -> None:
        ...
        self._default_language = self._config.get(
            "ocr_default_language",
            os.environ.get("OCR_DEFAULT_LANGUAGE", self._default_language),
        )
