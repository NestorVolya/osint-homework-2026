...
SUPPORTED_LANGUAGES = {
    "en": "English",
    "uk": "Ukrainian (Cyrillic model)",
    "ru": "Russian (Cyrillic model)",
    "cyrillic": "Cyrillic script (uk/ru/bg/sr)",
    ...
    "ja": "Japanese",
    "ko": "Korean",
    "latin": "Latin script (multilingual)",
}
...
async def list_languages():
    ...
    default_lang = _shard._default_language if _shard else "en"
    return {
        "default": default_lang,
        "languages": SUPPORTED_LANGUAGES,
        "note": "Ukrainian ('uk') and Russian ('ru') use the PaddleOCR Cyrillic model.",
    }
